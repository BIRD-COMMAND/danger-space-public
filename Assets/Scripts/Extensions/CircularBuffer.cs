...
namespace Extensions
{
	...
	public class CircularBuffer<T> : IEnumerable<T>
	{
		...
		/// <summary> Copies the most recent <paramref name="size"/> elements to an array and returns it. </summary>
		public T[] ToPartialArray(int size)
		{
			if (size >= Size) throw new ArgumentOutOfRangeException("size");
			T[] newArray = new T[size];
			for (int i = 0; i < size; i++) { newArray[i] = this[i]; }
			return newArray;
		}
