...
public abstract class Poolable : MonoBehaviour
{
	...
	/// <summary> Initializes the poolable object by setting its object pool,
	/// enqueuing it into the pool, and deactivating it. </summary>
	...
	public Poolable Initialize(ObjectPool pool) { 
		this.pool = pool; pool.queue.Enqueue(this);
		gameObject.SetActive(false); return this; 
	}
	...
	/// <summary> Deactivates the poolable object, resets its state,
	/// and returns the poolable object to its object pool. </summary>
